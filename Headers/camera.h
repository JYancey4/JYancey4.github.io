 ...
 *
 * Description:
 * This file declares the Camera class, which handles the camera's movement and orientation
 * logic in a 3D environment. It includes definitions for default camera attributes and
 * enumerations for camera movements.
 *
 */
